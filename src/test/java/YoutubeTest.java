...
public class YoutubeTest {
    ...
    public void login() {
        ...
        driver.get("https://www.youtube.com/");
        WebElement signin = driver.findElement(By.xpath("//*[@id=\"buttons\"]/ytd-button-renderer"));
        signin.click();
        ...
        WebElement next = driver.findElement(By.xpath("//*[@id=\"passwordNext\"]"));
        next.click();
    }
    ...
    public void logout(){
        ...
        login();
        WebElement avatar = driver.findElement(By.xpath("//*[@id=\"end\"]//ytd-topbar-menu-button-renderer//button[@id=\"avatar-btn\"]"));
        avatar.click();
